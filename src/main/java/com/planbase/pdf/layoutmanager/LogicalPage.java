...
public class LogicalPage { // AKA Document Section
    ...
    public float pageWidth() {
        return portrait ? pageSize.getWidth()
                : pageSize.getHeight();
    }
    ...
    private LogicalPage(PdfLayoutMgr m, boolean p, PDRectangle s) {
        mgr = m;
        portrait = p;
        pageSize = s;
    }
    ...
    public static LogicalPage of(PdfLayoutMgr m) {
        return new LogicalPage(m, false, PDPage.PAGE_SIZE_LETTER);
    }

    public static LogicalPage of(PdfLayoutMgr m, Orientation orientation) {
        return new LogicalPage(m, orientation == Orientation.PORTRAIT, PDPage.PAGE_SIZE_LETTER);
    }

    public static LogicalPage of(PdfLayoutMgr m, Orientation orientation, PDRectangle pageSize) {
        return new LogicalPage(m, orientation == Orientation.PORTRAIT, pageSize);
    }
...
//        System.out.println("putRow: maxHeight=" + maxHeight);
    ...
    static class PageBufferAndY {
        ...
        public PageBufferAndY(PageBuffer p, float theY) {
            pb = p;
            y = theY;
        }
    }
